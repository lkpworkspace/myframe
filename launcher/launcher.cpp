...
int main(int argc, char** argv) {
  ...
  args.SetStr(MYFRAME_ARG_KEY_SERVICE_LIB_DIR, lib_dir.string());
  args.SetInt(MYFRAME_ARG_KEY_THREAD_POOL_SIZE,
    module_args.GetThreadPoolSize());
  args.SetInt(MYFRAME_ARG_KEY_EVENT_CONNE_SIZE,
    module_args.GetConnEventSize());
  args.SetInt(MYFRAME_ARG_KEY_WARNING_MSG_SIZE,
    module_args.GetWarningMsgSize());
  args.SetInt(MYFRAME_ARG_KEY_PENDING_QUEUE_SIZE,
    module_args.GetDefaultPendingQueueSize());
  args.SetInt(MYFRAME_ARG_KEY_RUN_QUEUE_SIZE,
