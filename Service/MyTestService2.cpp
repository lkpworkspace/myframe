...
class MyTestService2 : public MyModule
{
public:
    MyTestService2(){}
    virtual ~MyTestService2(){}

    virtual int Init(MyContext* c, const char* param) override
    {
        std::cout << "MyTestService2 init" << std::endl;
        my_send(c, 0, 0x1, 0, 0, (void*)"init msg", 8);
...
int MyTestService2::m_count = 0;
std::string MyTestService2::m_srv = "MyTestService2: ";

extern "C" MyModule* my_mod_create()
{
    return static_cast<MyModule*>(new MyTestService2());
}
