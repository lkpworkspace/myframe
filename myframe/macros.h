...
#define MYFRAME_MSG_TYPE_SUB "MYFRAME_SUBSCRIBE"
#define MYFRAME_MSG_TYPE_PUB "MYFRAME_PUBLISH"
#define MYFRAME_MSG_TYPE_TIMER "MYFRAME_TIMER"
#define MYFRAME_MSG_TYPE_REQUEST "MYFRAME_REQUEST"
#define MYFRAME_MSG_TYPE_RESPONSE "MYFRAME_RESPONSE"
